<div class="max-w-2xl">
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h2 class="text-xl font-black text-gray-800">Edit Supplier</h2>
            <p class="text-sm text-gray-400">Update data supplier</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
        <form wire:submit="save" class="space-y-5">
            <div>
                <label class="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">Nama Supplier <span class="text-red-500">*</span></label>
            ...
            <div class="flex gap-3 pt-2">
                <a href="{{ route('suppliers.index') }}" class="flex-1 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold text-sm rounded-xl transition-colors text-center">Batal</a>
