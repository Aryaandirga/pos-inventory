<div class="max-w-4xl">
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h2 class="text-xl font-black text-gray-800">Tambah Produk</h2>
            <p class="text-sm text-gray-400">Tambah produk baru ke inventory</p>
        </div>
    </div>
        ...
        <div class="grid lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-5">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                <input type="text" wire:model="sku" placeholder="Kode produk..."
                                ...
                                <button type="button" wire:click="generateSku"
                                        class="px-4 py-3 bg-gray-100 hover:bg-gray-200 text-gray-600 text-sm font-semibold rounded-xl transition-colors">
                                    Generate
                                </button>
                            </div>
                        ...
                        <div>
                            ...
                            <textarea wire:model="description" rows="3" placeholder="Deskripsi produk..."
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" wire:model="cost_price" placeholder="0"
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">Stok Awal <span class="text-red-500">*</span></label>
                        ...
                        <div>
                            ...
                            <input type="number" wire:model="min_stock" placeholder="5"
                                   class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-700 text-sm focus:outline-none focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100 transition-all">
